    ...
    (
      <div
        style={{
          ...
          backgroundImage:
            "radial-gradient(circle at 20% 20%, rgba(67,233,123,0.22), transparent 44%), radial-gradient(circle at 80% 10%, rgba(0,242,254,0.22), transparent 46%)",
          color: "#eaf5f2",
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 940 }}>
          ...
          <span style={{ fontSize: 34, lineHeight: 1.25, color: "#b6cbc4" }}>
            Atención, triaje y agenda automatizados para clínicas veterinarias.
          </span>
        </div>
